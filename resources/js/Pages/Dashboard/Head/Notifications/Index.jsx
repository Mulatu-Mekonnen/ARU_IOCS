...
export default function Index({ notifications: initialNotifications, stats: initialStats }) {
  ...
  function getTypeLabel(type) {
    switch (type) {
      case 'new_communication': return 'New Communication';
      case 'communication_created': return 'Created';
      case 'approval_update': return 'Status Update';
      case 'communication_approved': return 'Approved';
      case 'pending_reminder': return 'Reminder';
      case 'forwarded_communication': 
      case 'communication_forwarded': return 'Forwarded';
      case 'rejected_communication':
      case 'communication_rejected': return 'Rejected';
